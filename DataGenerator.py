...
#labels_root = '/Users/rudrathaker/Desktop/Neural Networks/Project/labels.json'
...
class dataloader:
    ...
    def augment(self, image, mask):
        ...
        if apply:
            def augment(image, mask):
                ...
                image , mask = augment_func(image, mask)
    ...
    def tf_dataset(self, batch):
        ...
        train_set = train_set.map(self.augment) #Data Augmentation
